...
def main():
    ...
    atacante.cmd(f'alias ataque-syn="python3 {PROYECT_PATH}/src/ataques/syn_flood.py 10.0.0.1 80 500 0.001"')
    info('  atacante ataque-tcp          - Ejecutar ataque tcp_flood\n')
    atacante.cmd(f'alias ataque-tcp="python3 {PROYECT_PATH}/src/ataques/tcp_flood.py 10.0.0.1 80 500 0.001"')
    info('  atacante ataque-udp          - Ejecutar ataque udp_flood\n')
